...
export const createPayment = async (paymentInfo: any) => {
    const paymentData = {
        ...
        type: "json",
        success_url: `https://car-wash-booking-system-server-henna.vercel.app/api/payments?transactionId=${paymentInfo.tran_id}&status=success`,
        fail_url: `https://car-wash-booking-system-server-henna.vercel.app/api/payments?status=fail`,
        cancel_url: 'https://car-wash-booking-client.vercel.app/services',
